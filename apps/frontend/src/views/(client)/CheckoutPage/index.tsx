...
const CheckoutPage = () => {
  ...
  const handlePaymentInitiation = () => {
    ...
    const returnUrl = `${cleanBaseUrl}/checkout/success?package_id=${currentPackage._id}&plan_id=${selectedPlanId}`;
    const cancelUrl = `${cleanBaseUrl}/checkout/cancel?package_id=${currentPackage._id}&plan_id=${selectedPlanId}`;
